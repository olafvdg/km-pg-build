...
(function(b){function d(){if(!g.READY){g.event.determineEventTypes();for(var e in g.gestures){g.gestures.hasOwnProperty(e)&&g.detection.register(g.gestures[e]);}g.event.onTouch(document,g.EVENT_MOVE,g.detection.detect),g.event.onTouch(document,g.EVENT_END,g.detection.endDetect),g.READY=!0;}}var g=function(h,i){return new g.Instance(h,i||{});};g.defaults={stop_browser_behavior:{userSelect:"none",touchCallout:"none",touchAction:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}},g.HAS_POINTEREVENTS=navigator.pointerEnabled||navigator.msPointerEnabled,g.HAS_TOUCHEVENTS="ontouchstart" in b,g.EVENT_TYPES={},g.DIRECTION_DOWN="down",g.DIRECTION_LEFT="left",g.DIRECTION_UP="up",g.DIRECTION_RIGHT="right",g.POINTER_MOUSE="mouse",g.POINTER_TOUCH="touch",g.POINTER_PEN="pen",g.EVENT_START="start",g.EVENT_MOVE="move",g.EVENT_END="end",g.plugins={},g.READY=!1,g.Instance=function(h,e){var j=this;return d(),this.element=h,this.enabled=!0,this.options=g.utils.extend(g.utils.extend({},g.defaults),e||{}),this.options.stop_browser_behavior&&g.utils.stopDefaultBrowserBehavior(this.element,this.options.stop_browser_behavior),g.event.onTouch(h,g.EVENT_START,function(i){j.enabled&&g.detection.startDetect(j,i);}),this;},g.Instance.prototype={on:function(j,k){for(var l=j.split(" "),h=0;l.length>h;h++){this.element.addEventListener(l[h],k,!1);}return this;},off:function(j,k){for(var l=j.split(" "),h=0;l.length>h;h++){this.element.removeEventListener(l[h],k,!1);}return this;},trigger:function(h,i){var j=document.createEvent("Event");return j.initEvent(h,!0,!0),j.gesture=i,this.element.dispatchEvent(j),this;},enable:function(e){return this.enabled=e,this;}};var a=null,c=!1,f=!1;g.event={bindDom:function(j,l,m){for(var h=l.split(" "),k=0;h.length>k;k++){j.addEventListener(h[k],m,!1);}},onTouch:function(i,k,j){var h=this;this.bindDom(i,g.EVENT_TYPES[k],function(l){var e=l.type.toLowerCase();return e.match(/mouseup/)&&f?(f=!1,void 0):((e.match(/touch/)||e.match(/mouse/)&&1===l.which||g.HAS_POINTEREVENTS&&e.match(/down/))&&(c=!0),e.match(/touch|pointer/)&&(f=!0),!c||f&&e.match(/mouse/)||(g.HAS_POINTEREVENTS&&k!=g.EVENT_END&&g.PointerEvent.updatePointer(k,l),k===g.EVENT_END&&null!==a?l=a:a=l,j.call(g.detection,h.collectEventData(i,k,l)),g.HAS_POINTEREVENTS&&k==g.EVENT_END&&g.PointerEvent.updatePointer(k,l)),e.match(/up|cancel|end/)&&(c=!1,a=null,g.PointerEvent.reset()),void 0);});},determineEventTypes:function(){var e;e=g.HAS_POINTEREVENTS?g.PointerEvent.getEvents():["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"],g.EVENT_TYPES[g.EVENT_START]=e[0],g.EVENT_TYPES[g.EVENT_MOVE]=e[1],g.EVENT_TYPES[g.EVENT_END]=e[2];},getTouchList:function(e){return g.HAS_POINTEREVENTS?g.PointerEvent.getTouchList():e.touches?e.touches:[{identifier:1,pageX:e.pageX,pageY:e.pageY,target:e.target}];},collectEventData:function(j,l,h){var k=this.getTouchList(h,l),m=g.POINTER_TOUCH;return(h.type.match(/mouse/)||g.PointerEvent.matchType(g.POINTER_MOUSE,h))&&(m=g.POINTER_MOUSE),{center:g.utils.getCenter(k),timestamp:h.timestamp||(new Date).getTime(),target:h.target,touches:k,eventType:l,pointerType:m,srcEvent:h,preventDefault:function(){this.srcEvent.preventManipulation&&this.srcEvent.preventManipulation(),this.srcEvent.preventDefault&&this.srcEvent.preventDefault();},stopPropagation:function(){this.srcEvent.stopPropagation();},stopDetect:function(){return g.detection.stopDetect();}};}},g.PointerEvent={pointers:{},getTouchList:function(){var h=this.pointers,i=[];return Object.keys(h).sort().forEach(function(e){i.push(h[e]);}),i;},updatePointer:function(h,i){h==g.EVENT_END?delete this.pointers[i.pointerId]:(i.identifier=i.pointerId,this.pointers[i.pointerId]=i);},matchType:function(j,k){if(!k.pointerType){return !1;}var h={};return h[g.POINTER_MOUSE]=k.pointerType==k.MSPOINTER_TYPE_MOUSE||k.pointerType==g.POINTER_MOUSE,h[g.POINTER_TOUCH]=k.pointerType==k.MSPOINTER_TYPE_TOUCH||k.pointerType==g.POINTER_TOUCH,h[g.POINTER_PEN]=k.pointerType==k.MSPOINTER_TYPE_PEN||k.pointerType==g.POINTER_PEN,h[j];},getEvents:function(){return["pointerdown MSPointerDown","pointermove MSPointerMove","pointerup pointercancel MSPointerUp MSPointerCancel"];},reset:function(){this.pointers={};}},g.utils={extend:function(h,i){for(var j in i){h[j]=i[j];}return h;},getCenter:function(j){for(var l=[],m=[],h=0,k=j.length;k>h;h++){l.push(j[h].pageX),m.push(j[h].pageY);}return{pageX:(Math.min.apply(Math,l)+Math.max.apply(Math,l))/2,pageY:(Math.min.apply(Math,m)+Math.max.apply(Math,m))/2};},getVelocity:function(h,i,j){return{x:Math.abs(i/h)||0,y:Math.abs(j/h)||0};},getAngle:function(j,k){var l=k.pageY-j.pageY,h=k.pageX-j.pageX;return 180*Math.atan2(l,h)/Math.PI;},getDirection:function(j,l){var h=Math.abs(j.pageX-l.pageX),k=Math.abs(j.pageY-l.pageY);return h>=k?j.pageX-l.pageX>0?g.DIRECTION_LEFT:g.DIRECTION_RIGHT:j.pageY-l.pageY>0?g.DIRECTION_UP:g.DIRECTION_DOWN;},getDistance:function(j,k){var l=k.pageX-j.pageX,h=k.pageY-j.pageY;return Math.sqrt(l*l+h*h);},getScale:function(h,i){return h.length>=2&&i.length>=2?this.getDistance(i[0],i[1])/this.getDistance(h[0],h[1]):1;},getRotation:function(h,i){return h.length>=2&&i.length>=2?this.getAngle(i[1],i[0])-this.getAngle(h[1],h[0]):0;},isVertical:function(e){return e==g.DIRECTION_UP||e==g.DIRECTION_DOWN;},stopDefaultBrowserBehavior:function(j,l){var p,h=["webkit","khtml","moz","ms","o",""];if(l&&j.style){for(var k=0;h.length>k;k++){for(var m in l){l.hasOwnProperty(m)&&(p=m,h[k]&&(p=h[k]+p.substring(0,1).toUpperCase()+p.substring(1)),j.style[p]=l[m]);}}"none"==l.userSelect&&(j.onselectstart=function(){return !1;});}}},g.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(h,i){this.current||(this.stopped=!1,this.current={inst:h,startEvent:g.utils.extend({},i),lastEvent:!1,name:""},this.detect(i));},detect:function(j){if(this.current&&!this.stopped){j=this.extendEventData(j);for(var l=this.current.inst.options,m=0,h=this.gestures.length;h>m;m++){var k=this.gestures[m];if(!this.stopped&&l[k.name]!==!1&&k.handler.call(k,j,this.current.inst)===!1){this.stopDetect();break;}}this.current&&(this.current.lastEvent=j);}},endDetect:function(e){this.detect(e),this.stopDetect();},stopDetect:function(){this.previous=g.utils.extend({},this.current),this.current=null,this.stopped=!0;},extendEventData:function(k){var n=this.current.startEvent;if(n&&(k.touches.length!=n.touches.length||k.touches===n.touches)){n.touches=[];for(var j=0,m=k.touches.length;m>j;j++){n.touches.push(g.utils.extend({},k.touches[j]));}}var p=k.timestamp-n.timestamp,l=k.center.pageX-n.center.pageX,h=k.center.pageY-n.center.pageY,q=g.utils.getVelocity(p,l,h);return g.utils.extend(k,{deltaTime:p,deltaX:l,deltaY:h,velocityX:q.x,velocityY:q.y,distance:g.utils.getDistance(n.center,k.center),angle:g.utils.getAngle(n.center,k.center),direction:g.utils.getDirection(n.center,k.center),scale:g.utils.getScale(n.touches,k.touches),rotation:g.utils.getRotation(n.touches,k.touches),startEvent:n}),k;},register:function(h){var i=h.defaults||{};return i[h.name]===void 0&&(i[h.name]=!0),g.utils.extend(g.defaults,i),h.index=h.index||1000,this.gestures.push(h),this.gestures.sort(function(j,k){return j.index<k.index?-1:j.index>k.index?1:0;}),this.gestures;}},g.gestures=g.gestures||{},g.gestures.Hold={name:"hold",index:10,defaults:{hold_timeout:500,hold_threshold:1},timer:null,handler:function(h,i){switch(h.eventType){case g.EVENT_START:clearTimeout(this.timer),g.detection.current.name=this.name,this.timer=setTimeout(function(){"hold"==g.detection.current.name&&i.trigger("hold",h);},i.options.hold_timeout);break;case g.EVENT_MOVE:h.distance>i.options.hold_threshold&&clearTimeout(this.timer);break;case g.EVENT_END:clearTimeout(this.timer);}}},g.gestures.Tap={name:"tap",index:100,defaults:{tap_max_touchtime:250,tap_max_distance:10,doubletap_distance:20,doubletap_interval:300},handler:function(j,k){if(j.eventType==g.EVENT_END){var h=g.detection.previous;if(j.deltaTime>k.options.tap_max_touchtime||j.distance>k.options.tap_max_distance){return;}g.detection.current.name=h&&"tap"==h.name&&j.timestamp-h.lastEvent.timestamp<k.options.doubletap_interval&&j.distance<k.options.doubletap_distance?"doubletap":"tap",k.trigger(g.detection.current.name,j);}}},g.gestures.Swipe={name:"swipe",index:40,defaults:{swipe_max_touches:1,swipe_velocity:0.7},handler:function(h,i){if(h.eventType==g.EVENT_END){if(i.options.swipe_max_touches>0&&h.touches.length>i.options.swipe_max_touches){return;}(h.velocityX>i.options.swipe_velocity||h.velocityY>i.options.swipe_velocity)&&(i.trigger(this.name,h),i.trigger(this.name+h.direction,h));}}},g.gestures.Drag={name:"drag",index:50,defaults:{drag_min_distance:10,drag_max_touches:1,drag_block_horizontal:!1,drag_block_vertical:!1,drag_lock_to_axis:!1},triggered:!1,handler:function(j,k){if(g.detection.current.name!=this.name&&this.triggered){return k.trigger(this.name+"end",j),this.triggered=!1,void 0;}if(!(k.options.drag_max_touches>0&&j.touches.length>k.options.drag_max_touches)){switch(j.eventType){case g.EVENT_START:this.triggered=!1;break;case g.EVENT_MOVE:if(j.distance<k.options.drag_min_distance&&g.detection.current.name!=this.name){return;}g.detection.current.name=this.name;var h=g.detection.current.lastEvent.direction;k.options.drag_lock_to_axis&&h!==j.direction&&(j.direction=g.utils.isVertical(h)?0>j.deltaY?g.DIRECTION_UP:g.DIRECTION_DOWN:0>j.deltaX?g.DIRECTION_LEFT:g.DIRECTION_RIGHT),this.triggered||(k.trigger(this.name+"start",j),this.triggered=!0),k.trigger(this.name,j),k.trigger(this.name+j.direction,j),(k.options.drag_block_vertical&&g.utils.isVertical(j.direction)||k.options.drag_block_horizontal&&!g.utils.isVertical(j.direction))&&j.preventDefault();break;case g.EVENT_END:this.triggered&&k.trigger(this.name+"end",j),this.triggered=!1;}}}},g.gestures.Transform={name:"transform",index:45,defaults:{transform_min_scale:0.01,transform_min_rotation:1,transform_always_block:!1},triggered:!1,handler:function(j,l){if(g.detection.current.name!=this.name&&this.triggered){return l.trigger(this.name+"end",j),this.triggered=!1,void 0;}if(!(2>j.touches.length)){switch(l.options.transform_always_block&&j.preventDefault(),j.eventType){case g.EVENT_START:this.triggered=!1;break;case g.EVENT_MOVE:var h=Math.abs(1-j.scale),k=Math.abs(j.rotation);if(l.options.transform_min_scale>h&&l.options.transform_min_rotation>k){return;}g.detection.current.name=this.name,this.triggered||(l.trigger(this.name+"start",j),this.triggered=!0),l.trigger(this.name,j),k>l.options.transform_min_rotation&&l.trigger("rotate",j),h>l.options.transform_min_scale&&(l.trigger("pinch",j),l.trigger("pinch"+(1>j.scale?"in":"out"),j));break;case g.EVENT_END:this.triggered&&l.trigger(this.name+"end",j),this.triggered=!1;}}}},g.gestures.Touch={name:"touch",index:-1/0,defaults:{prevent_default:!1},handler:function(h,i){i.options.prevent_default&&h.preventDefault(),h.eventType==g.EVENT_START&&i.trigger(this.name,h);}},g.gestures.Release={name:"release",index:1/0,handler:function(h,i){h.eventType==g.EVENT_END&&i.trigger(this.name,h);}},"object"==typeof module&&"object"==typeof module.exports?module.exports=g:(b.Hammer=g,"function"==typeof b.define&&b.define.amd&&b.define("hammer",[],function(){return g;}));})(this),function(a){a&&(Hammer.event.bindDom=function(c,d,b){a(c).on(d,function(f){var g=f.originalEvent;g.pageX||(g.pageX=f.pageX,g.pageY=f.pageY),g.target||(g.target=f.target),g.which||(g.which=g.button),g.preventDefault||(g.preventDefault=f.preventDefault),g.stopPropagation||(g.stopPropagation=f.stopPropagation),b.call(this,g);});},Hammer.Instance.prototype.on=function(b,c){return a(this.element).on(b,c);},Hammer.Instance.prototype.off=function(b,c){return a(this.element).off(b,c);},Hammer.Instance.prototype.trigger=function(b,c){return a(c.srcEvent.target).trigger({type:b,gesture:c});},a.fn.hammer=function(b){return this.each(function(){var d=a(this),c=d.data("hammer");c?c&&b&&Hammer.utils.extend(c.options,b):d.data("hammer",Hammer(this,b||{}));});});}(window.jQuery||!1);
/*! jquery-ui-map rc1 | Johan S�ll Larsson */
;eval(function(h,b,j,f,g,i){g=function(a){return(a<b?"":g(parseInt(a/b)))+((a=a%b)>35?String.fromCharCode(a+29):a.toString(36));};if(!"".replace(/^/,String)){while(j--){i[g(j)]=f[j]||g(j);}f=[function(a){return i[a];}];g=function(){return"\\w+";};j=1;}while(j--){if(f[j]){h=h.replace(new RegExp("\\b"+g(j)+"\\b","g"),f[j]);}}return h;}('(3(d){d.a=3(a,b){j c=a.w(".")[0],a=a.w(".")[1];d[c]=d[c]||{};d[c][a]=3(a,b){K.I&&2.16(a,b)};d[c][a].J=d.n({1A:c,1z:a},b);d.S[a]=3(b){j g="1y"===1D b,f=H.J.12.15(K,1),i=2;l(g&&"1C"===b.1B(0,1))9 i;2.13(3(){j h=d.Z(2,a);h||(h=d.Z(2,a,k d[c][a](b,2)));l(g&&(h=h[b].10(h,f),"4"===b||o!=h))i=h});9 i}};d.a("1x.1t",{r:{1s:"1r",1w:5},1v:3(a,b){l(b)2.r[a]=b,2.4("8").B(a,b);P 9 2.r[a]},16:3(a,b){2.C=b;a=a||{};m.n(2.r,a,{1e:2.D(a.1e)});2.1c();2.1j&&2.1j()},1c:3(){j a=2;2.q={8:k 6.7.1u(a.C,a.r),L:[],t:[],u:[]};6.7.s.1N(a.q.8,"1M",3(){d(a.C).19("1L",a.q.8)});a.F(a.r.1Q,a.q.8)},1d:3(a){j b=2.4("1i",k 6.7.1P);b.n(2.D(a));2.4("8").1O(b)},1K:3(a){j b=2.4("8").1G();9 b?b.1F(a.18()):!1},1E:3(a,b){2.4("8").1J[b].O(2.z(a))},1I:3(a,b){a.8=2.4("8");a.Y=2.D(a.Y);j c=k(a.1H||6.7.1k)(a),e=2.4("L");c.V?e[c.V]=c:e.O(c);c.1i&&2.1d(c.18());2.F(b,a.8,c);9 d(c)},y:3(a){2.G(2.4(a));2.B(a,[])},G:3(a){A(j b R a)a.U(b)&&(a[b]p 6.7.T?(6.7.s.X(a[b]),a[b].x&&a[b].x(o)):a[b]p H&&2.G(a[b]),a[b]=o)},1p:3(a,b,c){a=2.4(a);b.v=d.1l(b.v)?b.v:[b.v];A(j e R a)l(a.U(e)){j g=!1,f;A(f R b.v)l(-1<d.1n(b.v[f],a[e][b.1q]))g=!0;P l(b.11&&"1m"===b.11){g=!1;1o}c(a[e],g)}},4:3(a,b){j c=2.q;l(!c[a]){l(-1<a.2i(">")){A(j e=a.14(/ /g,"").w(">"),d=0;d<e.I;d++){l(!c[e[d]])l(b)c[e[d]]=d+1<e.I?[]:b;P 9 o;c=c[e[d]]}9 c}b&&!c[a]&&2.B(a,b)}9 c[a]},2h:3(a,b,c){j d=2.4("Q",a.2j||k 6.7.2l);d.M(a);d.2k(2.4("8"),2.z(b));2.F(c,d)},2d:3(){o!=2.4("Q")&&2.4("Q").2c()},B:3(a,b){2.q[a]=b},2e:3(){j a=2.4("8"),b=a.2g();d(a).17("2f");a.2m(b)},2r:3(){2.y("L");2.y("u");2.y("t");2.G(2.q);m.2s(2.C,2.2t)},F:3(a){a&&d.2o(a)&&a.10(2,H.J.12.15(K,1))},D:3(a){l(!a)9 k 6.7.N(0,0);l(a p 6.7.N)9 a;a=a.14(/ /g,"").w(",");9 k 6.7.N(a[0],a[1])},z:3(a){9!a?o:a p m?a[0]:a p 2n?a:d("#"+a)[0]},2q:3(a,b){j c=k 6.7[a](m.n({8:2.4("8")},b));2.4("t > "+a,[]).O(c);9 d(c)},2p:3(a,b){(!b?2.4("t > E",k 6.7.E):2.4("t > E",k 6.7.E(b,a))).M(m.n({8:2.4("8")},a))},2b:3(a,b,c){2.4("t > "+a,k 6.7.1X(b,m.n({8:2.4("8")},c)))},1W:3(a,b,c){j d=2,g=2.4("u > 1f",k 6.7.1f),f=2.4("u > 1g",k 6.7.1g);b&&f.M(b);g.1Y(a,3(a,b){"20"===b?(f.1Z(a),f.x(d.4("8"))):f.x(o);c(a,b)})},1S:3(a,b){2.4("8").1R(2.4("u > 1a",k 6.7.1a(2.z(a),b)))},1T:3(a,b){2.4("u > 1b",k 6.7.1b).1V(a,b)}});m.S.n({17:3(a){6.7.s.19(2[0],a);9 2},W:3(a,b,c){6.7&&2[0]p 6.7.T?6.7.s.1U(2[0],a,b):c?2.1h(a,b,c):2.1h(a,b);9 2},27:3(a){6.7&&2[0]p 6.7.T?a?6.7.s.26(2[0],a):6.7.s.X(2[0]):2.28(a);9 2}});m.13("2a 29 22 21 23 25 24".w(" "),3(a,b){m.S[b]=3(a,d){9 2.W(b,a,d)}})})(m);',62,154,"||this|function|get||google|maps|map|return||||||||||var|new|if|jQuery|extend|null|instanceof|instance|options|event|overlays|services|value|split|setMap|clear|_unwrap|for|set|el|_latLng|FusionTablesLayer|_call|_c|Array|length|prototype|arguments|markers|setOptions|LatLng|push|else|iw|in|fn|MVCObject|hasOwnProperty|id|addEventListener|clearInstanceListeners|position|data|apply|operator|slice|each|replace|call|_setup|triggerEvent|getPosition|trigger|StreetViewPanorama|Geocoder|_create|addBounds|center|DirectionsService|DirectionsRenderer|bind|bounds|_init|Marker|isArray|AND|inArray|break|find|property|roadmap|mapTypeId|gmap|Map|option|zoom|ui|string|pluginName|namespace|substring|_|typeof|addControl|contains|getBounds|marker|addMarker|controls|inViewport|init|bounds_changed|addListenerOnce|fitBounds|LatLngBounds|callback|setStreetView|displayStreetView|search|addListener|geocode|displayDirections|KmlLayer|route|setDirections|OK|mouseover|dblclick|mouseout|dragend|drag|clearListeners|removeEventListener|unbind|rightclick|click|loadKML|close|closeInfoWindow|refresh|resize|getCenter|openInfoWindow|indexOf|infoWindow|open|InfoWindow|setCenter|Object|isFunction|loadFusion|addShape|destroy|removeData|name".split("|"),0,{}));function setHammer(){if(!Hammer.HAS_TOUCHEVENTS&&!Hammer.HAS_POINTEREVENTS){Hammer.plugins.fakeMultitouch();}$("#zoomwrap").css("height",$("#plattegrond .ui-content").height());var g=$("#zoomwrap").hammer({transform_always_block:true,transform_min_scale:1,drag_block_horizontal:true,drag_block_vertical:true,drag_min_distance:0});var a=$("#zoom");var d,c,q,p,n,l,m,k,h=Math.max($(window).height()/883,$(window).width()/1500),s=Math.max(h,0.8),b,f,o,r,j=0,i;g.on("tap touch drag dragstart dragend transform",function(x){switch(x.type){case"touch":b=s;break;case"tap":var u=(x.pageX-$("#floorplan").offset().left)/s;var t=(x.pageY-$("#floorplan").offset().top)/s;var y=false;var w=1;while(y==false&&u>0&&coX[w]>0){if((-3+coX[w]*1)<u&&u<(+27+coX[w]*1)&&(-3+coY[w]*1)<t&&t<(+27+coY[w]*1)){kmsysteem=systemen[w];y=true;if($(window).width()>1000){x.stopPropagation();x.preventDefault();x.stopImmediatePropagation();$("#plattegrond .systeempanel #naam").html(kmsysteem.naam);$("#plattegrond .systeempanel #intro").html(kmsysteem.intro);$("#plattegrond .systeempanel #eigenschappen").html("<ul><li>"+kmsysteem.eigenschappen.split("|").join("</li><li>")+"</li></ul>");$("#plattegrond .systeempanel #configuratie").html("<ul><li>"+kmsysteem.configuratie.split("|").join("</li><li>")+"</li></ul>");$("#plattegrond .systeempanel .listnumber").addClass(kmsysteem.type);$("#plattegrond .systeempanel .listnumber").html(kmsysteem.id);$("#plattegrond .systeempanel").panel("open");break;}else{$.mobile.changePage("systeem.html");}}w=w+1;}break;case"dragstart":n=(s-1)/2*1500;l=(s-1)/2*883;k=l-(s*883)+$(window).height()-110;m=n-(s*1500)+$(window).width();break;case"drag":d=q+x.gesture.deltaX;c=p+x.gesture.deltaY;d=Math.max(m,Math.min(d,n));c=Math.max(k,Math.min(c,l));break;case"transform":s=Math.max(h,Math.min(b*x.gesture.scale,2));break;case"dragend":q=d;p=c;break;}var v={left:d+"px",top:c+"px",transform:"scale("+s+")","-webkit-transform":"scale("+s+")"};a.css(v);});d=q=-0.5*(1500-$(window).width());c=p=-0.5*(883-$(window).height())+5;var e={left:d+"px",top:c+"px",transform:"scale("+s+")","-webkit-transform":"scale("+s+")"};a.css(e);a.css("-webkit-transform-origin","750px 441px");a.css("transform-origin","750px 441px");a.css("position","relative");n=(s-1)/2*1500;l=(s-1)/2*883;k=l-(s*883)+$(window).height()-110;m=n-(s*1500)+$(window).width();}function getData(){$.mobile.allowCrossDomainPages=true;$.support.cors=true;if((!localStorage.kmapp)||(new Date().getTime()-localStorage.kmapp_update>172800000)){console.log("Loading fresh data");$.getJSON("http://contact.konicaminolta.nl/app/data/data.php?callback=?",function(b){localStorage.clear();localStorage.kmapp=JSON.stringify(b);localStorage.kmapp_update=new Date().getTime();getData();});}else{console.log("Loading data from local storage");data=JSON.parse(localStorage.kmapp);var a=[];$.each(data,function(b,c){systemen[c.id]=c;coX[c.id]=c.x;coY[c.id]=c.y;a.push('<div style="position:absolute;text-align:center;top:'+c.y+"px;left:"+c.x+'px;" ><div class="id '+c.type+'">'+c.id+'</div><div class="naam">'+c.naam+"</div></div>");listdata.push("<li onclick=\"listClick('"+c.id+'\')"><a href="#">'+c.naam+'</a><div class="listnumber '+c.type+'">'+c.id+"</div></li>");$("#plattegrond #systemen").html(a.join(""));});}}var kmsysteem=new Object(),coX=new Array(),coY=new Array(),systemen=new Array(),listdata=new Array(),startmarker;$(document).ready(function(){$.mobile.page.prototype.options.backBtnText="&nbsp;";$.mobile.page.prototype.options.backBtnTheme="b";getData();setHammer();$("#startscherm h1").click(function(){localStorage.clear();location.reload();});});$(document).on("pagebeforeshow",'[id="systeem"]',function(){$("#systeem #naam").html(kmsysteem.naam);$("#systeem #intro").html(kmsysteem.intro);$("#systeem #eigenschappen").html("<ul><li>"+kmsysteem.eigenschappen.split("|").join("</li><li>")+"</li></ul>");$("#systeem #configuratie").html("<ul><li>"+kmsysteem.configuratie.split("|").join("</li><li>")+"</li></ul>");$("#systeem .listnumber").addClass(kmsysteem.type);$("#systeem .listnumber").html(kmsysteem.id);});$(document).on("pageinit",'[id="locatie"]',function(){if(typeof google!="undefined"){var a={content:'<div id="mapinfo"><strong>Konica Minolta<br/>Business Solutions Nederland BV</strong><br/>Hoogoorddreef 9<br/>1101BA Amsterdam<br/><hr/><strong>Openbaar vervoer</strong><br/>Vanaf Station Bijlmer-Arena is het vijf minuten lopen naar het Atlas-gebouw Afrika, waarin Konica Minolta Business Solutions Nederland BV is gevestigd. Komt u met de auto, dan kunt u parkeren in P10.<br/><br/><a rel="external" href="maps://maps.google.com/maps?daddr=52.309758,4.946202" target="_system" style="font-size:12px;line-height:1.3;">Route naar P9 (Google Maps)</a></div>'};$("#map_canvas").gmap({center:"52.309082,4.94706",zoom:14});$("#map_canvas").gmap().bind("init",function(b,c){startmarker=$("#map_canvas").gmap("addMarker",{position:"52.3091,4.9456",bounds:false,icon:"images/locatiemarker.png"}).click(function(){$("#map_canvas").gmap("openInfoWindow",a,this);});$("#map_canvas").gmap("addMarker",{position:"52.30987,4.946764",bounds:false,icon:"images/p_locatiemarker.png"}).click(function(){$("#map_canvas").gmap("openInfoWindow",{content:'<div id="mapinfo"><strong>Parkeergarage P9</strong><hr/>Loop vanuit de parkeerplaats naar links. Houd het gebouw aan uw rechterzijde en loop om het gebouw heen. Aan de andere kant vindt u de hoofdingang van gebouw Afrika. Konica Minolta is gevestigd op de begane grond. Meldt u zich a.u.b. bij de receptie.<br/><br/><a rel="external" href="maps://maps.google.com/maps?daddr=52.309758,4.946202" target="_system" style="font-size:12px;line-height:1.3;">Route naar P9 (Google Maps)</a>'},this);});$(document).on("pageshow",'[id="locatie"]',function(){if($("#map_canvas")&&(typeof google!="undefined")){}});});}else{alert("Geen internetverbinding beschikbaar...");location.reload();}});$(document).on("pageinit",'[id="contact"]',function(){$("#formulier").submit(function(){event.stopPropagation();event.preventDefault();if($("#formulier").valid()){$.post("http://contact.konicaminolta.nl/app/formulier/form.php",$("#formulier").serialize(),function(a){$("#contact .ui-content").html(a);});}});$("#formulier").validate({errorPlacement:function(a,b){$(b).attr("placeholder",a[0].outerText);},rules:{naam:{required:true},bedrijf:{required:true},email:{required:true},telefoon:{required:true},bericht:{required:true}},messages:{naam:"Uw naam is vereist.",bedrijf:"Uw bedrijfsnaam is vereist.",email:"Uw e-mailadres is vereist.",telefoon:"Uw telefoonnummer is vereist.",bericht:"Voer hier uw bericht in."}});});$(document).on("pagebeforecreate",'[id="systemen"]',function(){$("#listview").html(listdata.join(""));});var fixgeometry=function(){scroll(0,0);var e=$(".ui-header:visible");var d=$(".ui-footer:visible");var b=$(".ui-content:visible");var c=$(window).height();var a=c-109;a-=(b.outerHeight()-b.height());b.height(a);if($("#map_canvas")&&(typeof google!="undefined")){$("#map_canvas").gmap("refresh");}};$(document).ready(function(){$(window).bind("orientationchange resize pageshow",fixgeometry);$(window).trigger("resize");});function listClick(a){kmsysteem=systemen[a];if($(window).width()>1000){$("#systemen .systeempanel #naam").html(kmsysteem.naam);$("#systemen .systeempanel #intro").html(kmsysteem.intro);$("#systemen .systeempanel #eigenschappen").html("<ul><li>"+kmsysteem.eigenschappen.split("|").join("</li><li>")+"</li></ul>");$("#systemen .systeempanel #configuratie").html("<ul><li>"+kmsysteem.configuratie.split("|").join("</li><li>")+"</li></ul>");$("#systemen .systeempanel .listnumber").addClass(kmsysteem.type);$("#systemen .systeempanel .listnumber").html(kmsysteem.id);$("#systemen .systeempanel").panel("open");}else{$.mobile.changePage("systeem.html");}}
